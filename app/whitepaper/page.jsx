...
export default function WhitepaperPage() {
  ...
  return (
    <div className="container mx-auto  px-4 py-12 mx-10">
      {/* Page Header */}
      <motion.h1
      ...
      {/* Two-Column Layout */}
      <div className="flex flex-col ml-10 md:flex-row gap-8">
        ...
        <div className="flex-1 flex flex-col justify-between mr-10 gap-4">
      ...
      {/* Disclaimer Section */}
      <motion.div
        className="mt-12 bg-[var(--color-card)] rounded-2xl ml-10 mr-10 p-6 shadow-lg"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
      >
